    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Mahasiwa - Politeknik Elektronika Negeri Surabaya</a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
						  ...
						  <h3>Perpustakaan Politeknik Elektronika Negeri Surabaya</h3><br>
						 <div class="col-md-12">
								<a href="_MG_0814.jpg"  width="900" height="500">
								  <img src="_MG_0814.jpg" alt="Cinque Terre" width="900" height="500">
								</a>
							  </div>
						  </div>
                        </div>
