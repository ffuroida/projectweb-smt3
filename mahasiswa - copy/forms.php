    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Anggota - User</a>
            </div>
            <!-- Top Menu Items -->
...
<head>
    ...
    <title>Mahasiswa - Perpustakaan Elektronika Negeri Surabaya</title>
                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <input class="form-control" placeholder="Nama, ex: aji">
                            </div>
                            <div class="form-group">
                                <label>Level</label>
                                <input class="form-control" placeholder="Admin/Dosen/Mahasiswa">
                            </div>
                            <div class="form-group">
                                <label>Foto</label>
                                <input type="file">
                            ...
                            <div class="form-group">
                                <label>Alamat</label>
                                <input class="form-control" placeholder="surabaya">
                            </div>
                            <div class="form-group">
