                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Delete List Galery
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
						<?php
							...
							$sql = "DELETE FROM galery WHERE id_gambar = $id_gambar" ;
						...
						<table border="0">
                            ...
                            <div class="form-group">
                                <td><label>ID Galery</label></td>
								<td align='center'>:</td>
                                <td><input name = "id_gambar" type = "text"
								id = "id_gambar"></td>
                            </div>
							</tr>
							<tr>
                           <td><input name = "delete" type = "submit"
