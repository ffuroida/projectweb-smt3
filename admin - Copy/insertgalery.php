    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Upload Galery</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Upload Galery
                            </li>
                        </ol>
                    </div>
                </div>
					...
					if(isset($_POST['kirim'])){
						...
						if ( in_array( end($info), $allow) ) // is this file allowed
						{
							if ( move_uploaded_file( $_FILES['file']['tmp_name'], $todir . basename($_FILES['file']['name'] ) ) )
							{
								...
								$sql = "INSERT INTO galery (url, namagambar, gambar_date) VALUES ('$url','$namagambar','$tgl')";
