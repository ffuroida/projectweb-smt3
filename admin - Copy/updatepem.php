    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Update Buku</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Update Buku
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
						<?php
							...
							$judul = $_POST['judul'];
							$tgl_pinam = $_POST['tgl_pinam'];
							$tgl_kembali = $_POST['tgl_kembali'];
							$status = $_POST['status'];
							
							
							$sql = "UPDATE peminjaman SET id_user = $id_user, nama='$nama', id_buku=$id_buku, judul='$judul', tgl_pinam='$tgl_pinam', tgl_kembali='$tgl_kembali', status='$status'".
						...
						<table border="0">
                            ...
                            <div class="form-group">
								...
								<td align='center'>:</td>
                                <td><input name = "id_peminjaman" type = "text"
								id = "id_peminjaman"></td>
                            </div>
							</tr>
							<tr>
