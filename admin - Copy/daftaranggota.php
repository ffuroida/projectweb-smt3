    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Daftar Anggota</a>
            </div>
            <!-- Top Menu Items -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Daftar Anggota
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<h4>Cari</h4>
				<form action='daftaranggota.php'method="POST">
			  	<input type='text' value='' name='qcari'>
			  	<input type='submit' value='cari'><a href='daftaranggota.php' >All</a>
				<p>nama atau level</p>
				</form>
				<br>
				<br>
