    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Transaksi Peminjaman</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Transaksi Peminjaman
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <?php
									...
									$query = mysqli_query($connect, "SELECT * from peminjaman where nama='nana ramadijanti'");
